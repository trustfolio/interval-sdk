...
import type { AccessControlDefinition, ActionEnvironment, CtxUserRole } from './internalRpcSchema';
import type { IOClient, IOClientRenderValidator } from './classes/IOClient';
import type IOComponent from './classes/IOComponent';
import type { AnyIOComponent, ComponentReturnValue, MaybeMultipleComponentReturnValue } from './classes/IOComponent';
import type { IOPromise, OptionalIOPromise, ExclusiveIOPromise, DisplayIOPromise, InputIOPromise, MultipleableIOPromise } from './classes/IOPromise';
...
export type PageCtx = Pick<ActionCtx, 'user' | 'params' | 'environment' | 'organization' | 'redirect' | 'loading'> & {
    /**
...
export type IntervalActionHandler = (io: IO, ctx: ActionCtx) => Promise<IOFunctionReturnType | void>;
...
export type IntervalActionDefinition = IntervalActionHandler | ExplicitIntervalActionDefinition | Action;
export type IntervalRouteDefinitions = Record<string, IntervalActionDefinition | Page>;
export type IntervalPageHandler = (display: IO['display'], ctx: PageCtx) => Promise<Layout | undefined>;
export type RequiredPropsIOComponentFunction<MethodName extends T_IO_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props: Props) => IOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type RequiredPropsExclusiveIOComponentFunction<MethodName extends T_IO_INPUT_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props: Props) => ExclusiveIOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type IOComponentFunction<MethodName extends T_IO_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props?: Prettify<Props>) => IOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type InputIOComponentFunction<MethodName extends T_IO_INPUT_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props?: Prettify<Props>) => InputIOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type RequiredPropsInputIOComponentFunction<MethodName extends T_IO_INPUT_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props: Prettify<Props>) => InputIOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type MultipleableInputIOComponentFunction<MethodName extends T_IO_MULTIPLEABLE_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props?: Prettify<Props>) => MultipleableIOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type RequiredPropsMultipleableInputIOComponentFunction<MethodName extends T_IO_MULTIPLEABLE_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props: Prettify<Props>) => MultipleableIOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type DisplayIOComponentFunction<MethodName extends T_IO_DISPLAY_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props?: Prettify<Props>) => DisplayIOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type RequiredPropsDisplayIOComponentFunction<MethodName extends T_IO_DISPLAY_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props: Prettify<Props>) => DisplayIOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
export type ExclusiveIOComponentFunction<MethodName extends T_IO_INPUT_METHOD_NAMES, Props, Output = ComponentReturnValue<MethodName>> = (label: string, props?: Prettify<Props>) => ExclusiveIOPromise<MethodName, T_IO_PROPS<MethodName>, Output>;
...
export type ComponentRenderer<MethodName extends T_IO_METHOD_NAMES> = ({ components, choiceButtons, }: {
...
export type ComponentsRenderer<Components extends [AnyIOComponent, ...AnyIOComponent[]] = [
    AnyIOComponent,
    ...AnyIOComponent[]
]> = ({ components, validator, choiceButtons, }: {
...
export type Executor<MethodName extends T_IO_METHOD_NAMES, Output = ComponentReturnValue<MethodName>> = (resolve: (output: Output) => void, reject?: (err: IOError) => void) => void;
export type OptionalExecutor<MethodName extends T_IO_METHOD_NAMES, Output = ComponentReturnValue<MethodName>> = (resolve: (output: Output | undefined) => void, reject?: (err: IOError) => void) => void;
export type IOPromiseMap = {
    [MethodName in T_IO_METHOD_NAMES]: IOPromise<MethodName, T_IO_PROPS<MethodName>, any>;
};
export type AnyIOPromise = IOPromiseMap[T_IO_METHOD_NAMES];
export type DisplayIOPromiseMap = {
    [MethodName in T_IO_DISPLAY_METHOD_NAMES]: DisplayIOPromise<MethodName, T_IO_PROPS<MethodName>, any>;
};
...
export type GroupIOPromiseMap = {
    ...
    } ? never : IOPromise<MethodName, T_IO_PROPS<MethodName>, any>;
};
...
export type OptionalGroupIOPromise = OptionalGroupIOPromiseMap[T_IO_INPUT_METHOD_NAMES];
export type MaybeOptionalGroupIOPromise = GroupIOPromise | OptionalGroupIOPromise;
export type IOComponentDefinition<MethodName extends T_IO_METHOD_NAMES, Props, Output, DefaultValue = Output> = (this: IOClient, props: Props, onPropsUpdate?: Evt<T_IO_PROPS<MethodName>>) => {
    props?: T_IO_PROPS<MethodName>;
    getValue?: (response: T_IO_RETURNS<MethodName>) => Output;
    getDefaultValue?: (defaultValue: DefaultValue) => any;
    onStateChange?: (newState: T_IO_STATE<MethodName>) => Promise<T_IO_PROPS<MethodName>>;
};
...
export type ChoiceButtonConfigOrShorthand<Choice> = Choice | (ChoiceButtonConfig & {
    value: Choice;
});
